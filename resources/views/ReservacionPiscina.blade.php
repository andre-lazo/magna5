...
<b>Fecha:</b> {{$albercas->start}}
        ...
        <p class="centrado25 text-justify">Yo, {{$albercas->usuario}} propietario(a) de la villa asignada con el 
No.……..de la manzana ……de ésta Urbanización, solicito se digne autorizar el uso de la siguiente área comunitaria..................................................
para el {{$albercas->start}} en el horario de {{$albercas->hora}} , para la distracción propia y de mi familia.<br><br>  </p>
...
<tr >
<td align="center" width="360" height="25"> {{$albercas->visi1}} </td>
<td align="center"  width="240" height="25"> {{$albercas->pare1}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$albercas->visi2}} </td>
<td align="center"  width="240" height="25"> {{$albercas->pare2}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$albercas->visi3}}  </td>
<td align="center"  width="240" height="25"> {{$albercas->pare3}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$albercas->visi4}}  </td>
<td align="center"  width="240" height="25"> {{$albercas->pare4}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$albercas->visi5}} </td>
<td align="center"  width="240" height="25"> {{$albercas->pare5}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$albercas->visi6}} </td>
<td align="center"  width="240" height="25"> {{$albercas->pare6}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$albercas->visi7}} </td>
<td align="center"  width="240" height="25"> {{$albercas->par7}} </td>
</tr>
...
<br><br> Atentamente. <br><br> <b>Firma:</b> Confirmación Electrónica.<br><b> Nombres: {{$albercas->usuario}} </b><br> <b>Número C.C.:</b> </p>
