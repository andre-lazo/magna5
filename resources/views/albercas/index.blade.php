...
<table class="table table-bordered table-striped mb-0 table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-center"><button type="button" class=" btn btn-outline-danger" data-toggle="modal" data-target="#modalEliminar-{{$alberca->id}}"><i class="far fa-trash-alt"></i> Eliminar</button></td>
...
<!--MODAL-->
<form action="{{route('albercas.create')}}">
  @csrf
