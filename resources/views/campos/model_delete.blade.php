  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Estas seguro que quieres eliminar la reservacion de {{$campo->hora}}?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar </button>
        
        {!! Form::open(['action'=>[[App\Http\Controllers\CamposController::class,'destroy'],$campo->id], 'method'=>'delete']) !!}
        {{FORM::token()}}
